...
/*Test Only*/
*email="'steve.boylls@state.co.us'";
...
DATA _NULL_;
        ...
        PUT @1 "logging at all vital records offices. We are striving to improve the logging of security paper in COVIS throughout the"; 
...
DATA _NULL_;
        ...
        PUT @1 " "; 
        PUT @1 "For the previous quarter our report shows that &&val&i issued &&TotIss&i sheets of security paper";
        PUT @1 "with &&UAfor&i unaccounted for in COVIS. ";
        PUT @1 " ";
        ...
        PUT @1 "On the main COVIS screen, go to the Fee menu item. Click on the <Document Control Listing Report>. Enter the range of ";
        PUT @1 "dates or the range of security paper document control numbers you wish to check. Any gaps, errors or duplications will ";
